...
# Data Visualization
* This data visualization showcases the top five State Agencies and/or Indian Tribal Organizations with the highest average WIC participation score per year from (2013-2016), with distinct categories based on population groups. Pregnant and postpartum women are the two categories highlighted.
